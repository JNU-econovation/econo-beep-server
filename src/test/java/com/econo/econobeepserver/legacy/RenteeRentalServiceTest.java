...
////    @Test
////    void a() {
////        UserInfoDto userInfoDto = userApiImpl.getUserInfoDtoByPinCode("1234");
////        assertEquals(1, userInfoDto.getId());
////        assertEquals("이서현", userInfoDto.getUserName());
////        assertEquals("1234", userInfoDto.getPinCode());
////    }
//
////    @Test
////    void b() {
////        assertThrows(NotFoundPinCodeException.class, () -> userApiImpl.getUserInfoDtoByPinCode("9999"));
////    }
//
//
