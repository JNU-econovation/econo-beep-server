...
public class BookImageController {
    ...
    public void getBookCoverImageByBookId(HttpServletResponse response, @PathVariable(value = "id") Long id) {
        String imageFilePath = bookService.getBookCoverImageFilePathByBookId(id);
